        ...
        <Row>
          <Col>
            <div className="Projectbox">
              <center><h4>Associate Software Engineer Trainee</h4></center>
              <center><h3>Nagarro</h3></center>
              <center><h6>07/2022 - 10/2022</h6></center>
              <p style={{ lineHeight: "100%" }}>
                <span style={{ color: "#ff0157", fontSize: "50px" }}>.</span> Java Training: Its process consists of various courses which includes data structures, database management, MVC
(Model-View-Controller) App development and frontend (Angular) training which helps in learning various technologies
and tools. <br />
                {/* <span style={{ color: "#ff0157", fontSize: "50px" }}>.</span> <br /> */}
                <span style={{ color: "#ff0157", fontSize: "50px" }}>.</span> Technology & Tools: Angular, HTML, CSS, JavaScript, SQL, Java, Spring Boot, Spring MVC, Maven<br /></p>
            </div>
          </Col>
        </Row>
